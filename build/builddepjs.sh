#!/bin/bash
#=====================================================================
# MarlinDT Network Intelligence (MNI) - Dependency README Generator
#
...
echo "---" > docs/nodejs-dependencies.md
echo "author: Merkator nv/sa <support@marlindt.net>" >> docs/nodejs-dependencies.md
echo "url: https://www.merkator.com/" >> docs/nodejs-dependencies.md
echo "footer: © 2024-2025 Merkator nv/sa. All rights reserved." >> docs/nodejs-dependencies.md
echo "title: MarlinDT Network Intelligence (MNI)" >> docs/nodejs-dependencies.md
echo "paginate: false" >> docs/nodejs-dependencies.md
echo "version: ${MNI_VERSION}.${MNI_BUILD}" >> docs/nodejs-dependencies.md
echo "---" >> docs/nodejs-dependencies.md

## Generate title for markdown document
echo -e "\n# MarlinDT Network Intelligence\n\n" >> docs/nodejs-dependencies.md
echo -e "\n>Version: ${MNI_VERSION}.${MNI_BUILD}\n\n" >> docs/nodejs-dependencies.md
echo -e "\n[TOC]\n\n" >> docs/nodejs-dependencies.md
