#!/bin/bash
#=====================================================================
# Network Insight (NI) - CI/CD Pipeline
#
...
js_obfuscate "ui/dist/js" "ni*.js" "browser" "low" && \
...
tar ${TAR_OPTIONS} ni_alertService_${NI_VERSION}.tar.gz alertService/* && \
tar ${TAR_OPTIONS} ni_apiGateway_${NI_VERSION}.tar.gz apiGateway/* && \
tar ${TAR_OPTIONS} ni_apiServer_${NI_VERSION}.tar.gz apiServer/* && \
tar ${TAR_OPTIONS} ni_dnsServer_${NI_VERSION}.tar.gz dnsServer/* && \
tar ${TAR_OPTIONS} ni_fetchService_${NI_VERSION}.tar.gz fetchService/* && \
tar ${TAR_OPTIONS} ni_iamServer_${NI_VERSION}.tar.gz iamServer/* && \
tar ${TAR_OPTIONS} ni_predictService_${NI_VERSION}.tar.gz predictService/* && \
tar ${TAR_OPTIONS} ni_uiServer_${NI_VERSION}.tar.gz uiServer/* && \
${NI_MD5} ni_alertService_${NI_VERSION}.tar.gz > ni_alertService_${NI_VERSION}.md5 && \
${NI_MD5} ni_apiGateway_${NI_VERSION}.tar.gz > ni_apiGateway_${NI_VERSION}.md5 && \
${NI_MD5} ni_apiServer_${NI_VERSION}.tar.gz > ni_apiServer_${NI_VERSION}.md5 && \
${NI_MD5} ni_dnsServer_${NI_VERSION}.tar.gz > ni_dnsServer_${NI_VERSION}.md5 && \
${NI_MD5} ni_fetchService_${NI_VERSION}.tar.gz > ni_fetchService_${NI_VERSION}.md5 && \
${NI_MD5} ni_iamServer_${NI_VERSION}.tar.gz > ni_iamServer_${NI_VERSION}.md5 && \
${NI_MD5} ni_predictService_${NI_VERSION}.tar.gz > ni_predictService_${NI_VERSION}.md5 && \
${NI_MD5} ni_uiServer_${NI_VERSION}.tar.gz > ni_uiServer_${NI_VERSION}.md5 && \
tar ${TAR_OPTIONS} ni_${NI_VERSION}.tar.gz ni_*_${NI_VERSION}.tar.gz ni_*_${NI_VERSION}.md5 && \
${NI_MD5} ni_${NI_VERSION}.tar.gz > ni_${NI_VERSION}.md5 && \
rm -f ni_alertService_${NI_VERSION}.* \
      ni_apiGateway_${NI_VERSION}.* \
      ni_apiServer_${NI_VERSION}.* \
      ni_dnsServer_${NI_VERSION}.* \
      ni_fetchService_${NI_VERSION}.* \
      ni_iamServer_${NI_VERSION}.* \
      ni_predictService_${NI_VERSION}.* \
      ni_uiServer_${NI_VERSION}.* &>/dev/null
RETVAL=$?
[[ ${RETVAL} -eq 0 ]] && success "- ok" || error "- fail"
