...
INSERT INTO adminEmail (id,vendor,address,name) VALUES (getvariable('eId'),'FastMail','ni@marlindt.net','MarlinDT Network Intelligence');
INSERT INTO adminEmailSend (id,adminEmailId,username,password,host,port,protocol,authentication,encryptionEnabled,encryptionStartTls) 
  VALUES (getvariable('esId'),getvariable('eId'),'ni@marlindt.net','password123&#','smtp.fastmail.com',465,'smtp','PLAIN',true,false);
RESET VARIABLE esId;
...
INSERT INTO adminKafka (id,name,clientId,username,password,host,port,retryDelay,retries,acks,linger,batchSize,bufferMemory,maxInFlightRequestsPerConnection,compressionMethod,authentication) VALUES (getvariable('kId'),'west','mni','ni@marlindt.net','password123&#','10.72.34.16',9092,10000,2,'leader',0,16,32,5,'none','none');
RESET VARIABLE kId;

--- Map providers

INSERT INTO adminMap (id,vendor,systemDefault,renderUrl,credentialsIdentity,credentialsKey) 
VALUES ('7993cdd4-395b-456c-9005-4cc7a62715b2','Google Maps',true,'https://maps.googleapis.com/maps/api/js','mni','AIzaSyD4TcrXO9v4qSNYtQD3AQqdDyhecJ_j9lw');
