#!/bin/bash
#=====================================================================
# Network Insight (NI) - Prediction Server Upgrade
#
...
alert "NI Prediction Server Upgrade"
...
cp -f ${CLI_PATH}/*.mjs ${WORKING_DIRECTORY}/ && chown ${USERNAME}:${GROUP} ${WORKING_DIRECTORY}/ && chmod 660 ${WORKING_DIRECTORY}/*.mjs
RETVAL=$?
