//=====================================================================
// MarlinDT Network Intelligence (MNI) - JavaScript: Map Providers
//
...
function saveProvider() {
  ...
  if (vendor != "-1") {
    if (document.getElementById("renderUrl").value.length > 0) {
      if (
        document.getElementById("credentialKey").value.length > 0 ||
        document.getElementById("idpBase").value.length > 0
      ) {
