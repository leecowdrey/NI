//=====================================================================
// Network Insight (NI) - JavaScript: Email Providers
//
...
function deleteProvider() {
  ...
  if (id != null && id != "-1") {
    fetch(
      localStorage.getItem("ni.gatewayUrl") + "/admin/email/provider/" + id,
      {
        method: "DELETE",
        keepalive: true,
      }
...
function fetchProviderList() {
  fetch(localStorage.getItem("ni.gatewayUrl") + "/admin/email/provider", {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
