//=====================================================================
// Network Insight (NI) - JavaScript: Kafka Providers
//
...
function deleteProvider() {
  ...
  if (id != null && id != "-1") {
    fetch(
      localStorage.getItem("ni.gatewayUrl") + "/admin/kafka/broker/" + id,
      {
        method: "DELETE",
        keepalive: true,
      }
...
function clearProvider() {
  ...
  document.getElementById("clientId").value = "NI";
...
function fetchProviderList() {
  fetch(localStorage.getItem("ni.gatewayUrl") + "/admin/kafka/broker", {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
