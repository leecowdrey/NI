//=====================================================================
// Network Insight (NI) - JavaScript: Workflow
//
...
function deleteProvider() {
  ...
  if (id != null && id != "-1") {
    fetch(
      localStorage.getItem("ni.gatewayUrl") + "/admin/workflow/engine/" + id,
      {
        method: "DELETE",
        keepalive: true,
      }
    ...
    if (document.getElementById("engineUrl").value.length > 0) {
      ...
      if (engineType != "-1") {
        if (id == "-1") {
          ...
          fetch(
            localStorage.getItem("ni.gatewayUrl") + "/admin/workflow/engine",
            {
              method: "POST",
              headers: {
...
function fetchProviderList() {
  ...
  fetch(localStorage.getItem("ni.gatewayUrl") + "/admin/workflow/engine", {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
